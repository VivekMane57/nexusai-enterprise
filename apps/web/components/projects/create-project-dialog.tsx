        ...
        >
          <div>
            ...
            <input
              ...
              type="text"
              autoFocus
              placeholder="Example: Financial Intelligence Copilot"
              {...register("name")}
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Describe the AI use case, target users and goals..."
              {...register(
                "description",
              )}
          ...
          <div className="rounded-2xl border border-violet-100 bg-violet-50/70 p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-violet-700">
              Knowledge bases, documents and
              conversations created under this
              project remain isolated from other
              projects.
            </p>
          </div>
